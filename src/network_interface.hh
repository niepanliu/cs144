...
private:
  ...
  std::unordered_map<uint32_t, std::pair<EthernetAddress, uint64_t>> ipToEther {};
  std::unordered_map<uint32_t, uint64_t> arp_time {};
  std::unordered_map<uint32_t, std::vector<InternetDatagram>> wait_queue {};
  std::queue<EthernetFrame> out_frame {};
public:
